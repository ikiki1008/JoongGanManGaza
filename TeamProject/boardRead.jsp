...
<body>
	...
	<div class="container">
		<div class="row">
			<form method="post" action="boardUpdateWrite.jsp">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				<thead>
					<tr>
						<th colspan="2" style="background-color: #eeeeee; text-align: center;">자유게시판 상세페이지</th>						
					</tr>
				</thead>
				<tbody>
					<tr>
			...
			<input type="button" style="margin:3px;" class="btn btn-primary pull-right" onclick="location.href='board.jsp'" value="목록">
			<input type="button" style="margin:3px;" class="btn btn-primary pull-left" onclick="delfunc()" value="삭제">
			<input type="submit" style="margin:3px;" class="btn btn-primary pull-right" value="수정">
			</form>						
		</div>
	</div>
	...
	function delfunc(){
		...
		if(del==true){
			location.href='boardDel.jsp?num=<%=num%>';
		}else{}
	}
