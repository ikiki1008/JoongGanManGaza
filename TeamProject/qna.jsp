...
<%
	...
	ArrayList<BoardDto> dtos = dao.qnalist();
%>
<!DOCTYPE html>
<html>
    ...
    <div class="list"><br>
        ...
        <div id="tablestyle">
            <div id="btns">
                ...
                <%if(id!=null) {%>
                <button id="btnright" onclick="location='qnawrite.jsp'">게시글작성</button>
                <%} else{%>
            ...
            <table>
                ...
                <tbody>
                	...
                	%>
	                	<td><%=dto.getNum()%></td>
	                	<td><a href="qnaRead.jsp?num=<%=dto.getNum()%>"><%=dto.getTitle()%></a></td>
	                	<td><%=dto.getId()%></td>
	                	<td><%=dto.getDt()%></td>
                	</tr>
                	<%
