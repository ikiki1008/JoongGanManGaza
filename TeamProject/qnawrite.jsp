...
<body>
	...
	<div class="container">
		<div class="row">
			<form method="post" action="qnaPro.jsp">
				...
				<thead>
					<tr>
						<th colspan="2" style="background-color: #eeeeee; text-align: center;">문의사항 글작성</th>						
					</tr>
				</thead>
				<tbody>
					<tr>
			...
			<input type="button" style="margin:3px;" class="btn btn-primary pull-right" onclick="location.href='qna.jsp'" value="취소">
	...
	function checkboard(){
		...
		if(ctitle.value!=""&&ccontent.value!=""){
			location.href='qnaPro.jsp?title='+(ctitle.value)+'+&content='+(ccontent.value);
