	...
	<div class="container">
		<div class="row">
			<form method="post" action="noticeUpdatePro.jsp">
				...
				<thead>
					<tr>
						<th colspan="2" style="background-color: #eeeeee; text-align: center;">공지사항 글수정</th>						
					</tr>
				</thead>
				<tbody>
					<tr>
					...
					<tr>
						<td><textarea id="content" name="bbsContent" class="form-control" maxlength="2048" style="height: 350px" req
						><%=content %></textarea></td>
...
function checkboard(){
	...
	if(ctitle.value!=""&&ccontent.value!=""){
		location.href='noticeUpdatePro.jsp?title='+(ctitle.value)+'+&content='+(ccontent.value);
