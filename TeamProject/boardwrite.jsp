...
<body>
	...
	<div class="container">
		<div class="row">
			<form method="post" action="boardPro.jsp">
				...
				<thead>
					<tr>
						<th colspan="2" style="background-color: #eeeeee; text-align: center;">자유게시판 글작성</th>						
					</tr>
				</thead>
				<tbody>
					<tr>
						<td><input type="text" id="title" name="bbsTitle" class="form-control" placeholder="글 제목" maxlength="50" required="required"></td>
					</tr>
					<tr>
						<td><textarea id="content" name="bbsContent" class="form-control" placeholder="글 내용" maxlength="2048" style="height: 350px" required="required"></textarea></td>						
					</tr>
				</tbody>
			</table>
			<input type="button" style="margin:3px;" class="btn btn-primary pull-right" onclick="location.href='board.jsp'" value="취소">
	...
	function checkboard(){
		...
		if(ctitle.value!=""&&ccontent.value!=""){
			location.href='boardPro.jsp?title='+(ctitle.value)+'+&content='+(ccontent.value);
