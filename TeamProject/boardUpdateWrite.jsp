...
String sql = "select title, content from board where num='"+num+"'";
...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<input type="button" style="margin:3px;" class="btn btn-primary pull-right" onclick="javascript:history.back()" value="취소">
...
function checkboard(){
	...
	if(ctitle.value!=""&&ccontent.value!=""){
		location.href='boardUpdatePro.jsp?title='+(ctitle.value)+'+&content='+(ccontent.value);
