...
<body>
	...
	<div class="container">
		<div class="row">
			<form method="post" action="qnaUpdateWrite.jsp">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				<thead>
					<tr>
						<th colspan="2" style="background-color: #eeeeee; text-align: center;">문의사항 상세페이지</th>						
					</tr>
				</thead>
				<tbody>
					<tr>
			...
			<input type="button" style="margin:3px;" class="btn btn-primary pull-right" onclick="location.href='qna.jsp'" value="목록">
	...
	function delfunc(){
		...
		if(del==true){
			location.href='qnaDel.jsp?num=<%=num%>';
		}else{}
	}
